...
//  
//
//  Created by Lemon  yu  on 15-07-13.
//  Copyright 2011年 __MyCompanyName__. All rights reserved.
//

#import "CHCTimeUtil.h"
...
+ (NSString *)getCurSystemGMTTimeOffSet
{
  ...
  NSInteger interval = [CHCTimeUtil getCurSystemGMTTimeInterval];
...
+ (NSString *)getTodayWeekday
{
  ...
  NSString *sWeek = [NSString stringWithFormat:@"%ld",(long)week];
