...
@interface CHCPopupMenuItem : NSObject

{
  UIImage *iImage;
  NSString *iTitle;
  __unsafe_unretained id iTarget;
  SEL iAction;
  UIColor *iFforeColor;
...
/*!
 @property
 @abstract iHighLightColor title文字高亮颜色
 */
@property (nonatomic,retain) UIColor *iHighLightColor;

/*!
 @property
 @abstract iHighLightImage 高亮图片
 */
