...
static CHCPopupMenu *gMenu;
static UIColor      *gTintColor;
static UIFont       *gTitleFont;

@implementation CHCPopupMenu
{
  CHCPopupMenuView    *iMenuView;
  BOOL                iObserving;
}
@synthesize iMarginX;
@synthesize iMarginY;
...
//  NSParameterAssert(menuItems.count);
  ...
  iMenuView = [[CHCPopupMenuView alloc] init];
