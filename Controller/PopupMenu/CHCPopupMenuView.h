...
#import "CHCPopupMenuItem.h"
#import "CHCPopupMenu.h"
...
@interface CHCPopupMenuView : UIView
 ...
 */
@property(nonatomic,retain) CHCPopMenuBaseView    *iBaseView;
